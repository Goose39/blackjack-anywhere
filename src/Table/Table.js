...
export default function Table(props) {
  return (
  <>  
    <TableHeader user={props.user} balance={props.balance} updateDecks={props.updateDecks} decks={props.decks} handStarted={props.handStarted} handleSetUser={props.handleSetUser} />
